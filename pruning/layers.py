# From https://github.com/zepx/pytorch-weight-prune/blob/develop/pruning/layers.py
...
class MaskedLinear(nn.Linear):
    ...
    def set_mask(self, mask):
        ...
        mask_var = self.get_mask().to('cuda:0')
...
class MaskedConv2d(nn.Conv2d):
    ...
    def set_mask(self, mask):
        ...
        self.weight.data = (self.weight.data).to('cuda:0')*(mask_var.data).to('cuda:0')
        self.mask_flag = True
